...
public class AboutActivity extends AppCompatActivity implements JsonTask.JsonTaskListener  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new RecyclerViewAdapter(this, recyclerViewItems, new RecyclerViewAdapter.OnClickListener() {
            ...
            public void onClick(RecyclerViewItem item) {
                Toast.makeText(AboutActivity.this, item.getTitle(), Toast.LENGTH_SHORT).show();
            }
        });
